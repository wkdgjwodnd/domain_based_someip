...
public:
    ...
    std::shared_ptr<message> create_notification(bool _reliable = false) const;
    std::shared_ptr<message> create_notification_with_domain(const byte_t domain_num_, bool _reliable) const;
